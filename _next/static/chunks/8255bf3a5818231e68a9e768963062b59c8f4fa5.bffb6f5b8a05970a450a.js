  ...
  [3],
  {
      ...
      e.exports = function (e, t, r, u) {
        return (
          ...
          "object" === typeof e
            ...
            : u
            ? encodeURIComponent(n(u)) + r + encodeURIComponent(n(e))
            : ""
        );
      };
      var o =
    ...
    QmWs: function (e, t, r) {
      ...
      function m(e, t, r) {
        ...
        var n = (e = e.trim()).match(p);
        (e = n ? d(n[1]).replace(/\\/g, "/") + n[2] : d(e).replace(/\\/g, "/")),
          v.test(e) && "/" !== e.slice(-1) && (e += "/");
        var a = !/(^javascript)/.test(e) && e.match(f),
          u = h.test(e),
          m = "";
        a &&
          (l.test(a[1]) || ((m = a[1].toLowerCase()), (e = "" + a[2] + a[3])),
          a[2] ||
            ((u = !1),
            l.test(a[1]) ? ((m = a[1]), (e = "" + a[3])) : (e = "//" + a[3])),
        ...
        try {
          ...
          try {
            ...
            return (_.protocol = m), (_.href = m), _;
          }
        }
        (_.slashes = u && !S),
          (_.host = y.host === c ? "" : y.host),
          (_.hostname =
            y.hostname === c ? "" : y.hostname.replace(/(\[|\])/g, "")),
          (_.protocol = w ? m || null : y.protocol),
          (_.search = y.search.replace(/\\/g, "%5C")),
          (_.hash = y.hash.replace(/\\/g, "%5C"));
        var P = e.split("#");
        !_.search && ~P[0].indexOf("?") && (_.search = "?"),
          _.hash || "" !== P[1] || (_.hash = "#"),
          (_.query = t ? o.decode(y.search.substr(1)) : _.search.substr(1)),
          (_.pathname = S + d(y.pathname).replace(/"/g, "%22")),
          "about:" === _.protocol &&
            "blank" === _.pathname &&
      ...
      function b(e, t) {
        ...
        var c = new URL(e, s + "/"),
          l = new URL(t, c).toString().replace(s, ""),
    ...
    elyg: function (e, t, r) {
          ...
          a(this, e),
            ...
            (this.onPopState = function (e) {
              if (e.state) {
                ...
                i.changeState(
                  "replaceState",
                  l.formatWithValidation({ pathname: a, query: u }),
                  l.getURL()
                );
              }
            }),
            (this._getStaticData = function (e) {
              var t = m(c.parse(e).pathname);
              return i.sdc[t]
            ...
            (this.query = r),
            (this.asPath =
              p.isDynamicRoute(t) && __NEXT_DATA__.autoExport ? t : n),
            (this.sub = b),
            (this.clc = null),
            (this._wrapApp = h),
            (this.isSsr = !0),
            ...
            this.changeState(
              "replaceState",
              l.formatWithValidation({ pathname: t, query: r }),
              n
            ),
                ...
                value: function (t, r, n, o) {
                  ...
                  return new Promise(function (i, u) {
                    ...
                    var s =
                      ...
                      m = "object" === typeof n ? l.formatWithValidation(n) : n;
                    if (
                      (a.abortComponentLoad(m), !o._h && a.onlyAHashChange(m))
                    )
                      return (
                        (a.asPath = m),
                        e.events.emit("hashChangeStart", m),
                        a.changeState(t, s, v(m), o),
                        a.scrollToHash(m),
                        e.events.emit("hashChangeComplete", m),
                        i(!0)
                      );
                    var y = c.parse(s, !0),
                      g = y.pathname,
                      ...
                      _ = y.protocol;
                    if (!g || _) return i(!1);
                    a.urlIsNew(m) || (t = "replaceState");
                    var w = d(g),
                      S = o.shallow,
                      P = void 0 !== S && S;
                    if (p.isDynamicRoute(w)) {
                      var C = c.parse(m).pathname,
                        R = h.getRouteRegex(w),
                        O = f.getRouteMatcher(R)(C);
                      if (O) Object.assign(b, O);
                      else if (
                        Object.keys(R.groups).filter(function (e) {
                          return !b[e];
                        }).length > 0
                      )
                        return u(
                    ...
                    e.events.emit("routeChangeStart", m),
                      a.getRouteInfo(w, g, b, m, P).then(function (r) {
                        var n = r.error;
                        if (n && n.cancelled) return i(!1);
                        if (
                          (e.events.emit("beforeHistoryChange", m),
                          a.changeState(t, s, v(m), o),
                          a.set(w, g, b, m, r),
                          n)
                        )
                          throw (e.events.emit("routeChangeError", n, m), n);
                        return e.events.emit("routeChangeComplete", m), i(!0);
                      }, u);
                  });
                },
              },
                  ...
                  return new Promise(function (o, a) {
                    ...
                    u &&
                      ...
                      Promise.all([
                        ...
                        t.pageLoader[n.priority ? "loadPage" : "prefetch"](
                          d(u)
                        ),
                      ]).then(function () {
                        return o();
      ...
      (t.default = g), (g.events = s.default());
    },
    "g/15": function (e, t, r) {
      "use strict";
      var n = r("vJKn");
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  ...
                  case 4:
                    ...
                    return (s.next = 9), n.awrap(e(r.Component, r.ctx));
                  case 9:
                    return (
                  ...
                  case 12:
                    return (s.next = 14), n.awrap(t.getInitialProps(r));
                  case 14:
                    if (((a = s.sent), !o || !u(o))) {
                      s.next = 17;
                      break;
